...
\title[Up/Down/Cross converter with audio embedder and dembedder] % [] is optional - is placed on the bottom of the sidebar on every slide
{ % is placed on the title page
      \textbf{SD/HD/3G Up/Down/Cross converter with audio embedder and dembedder}
}
